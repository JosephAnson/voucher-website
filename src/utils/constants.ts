...
export const BANNED_CODES: BannedCode[] = [
  ...
  { reason: 'banned', code: 'bitmart.news' },
  ...
  { reason: 'banned', code: 'get.hexanetwork.co' },
  { reason: 'banned', code: 'hexminor.io' },
  { reason: 'banned', code: 'mlion.us' },
  { reason: 'banned', code: 'moneylion.oneline.me' },
