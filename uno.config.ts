...
export default defineConfig({
  ...
  theme: {
    ...
    fontSize: {
      ...
      'sm': ['0.875rem', { 'line-height': '1.5rem' }],
      'base': ['1rem', { 'line-height': '1.75rem' }],
      'lg': ['1.125rem', { 'line-height': '2rem' }],
      'xl': ['1.25rem', { 'line-height': '2rem' }],
      '2xl': ['1.5rem', { 'line-height': '2rem' }],
      '3xl': ['2rem', { 'line-height': '2.5rem' }],
      '4xl': ['2.5rem', { 'line-height': '3.5rem' }],
      '5xl': ['3rem', { 'line-height': '3.5rem' }],
      '6xl': ['3.75rem', { 'line-height': '1' }],
      '7xl': ['4.5rem', { 'line-height': '1.1' }],
  ...
  preflights: [{
    ...
    getCSS: ({ theme }) => {
      ...
      const gray = theme?.colors?.gray?.[500] as string ?? '#6b7280'
      // eslint-disable-next-line ts/no-unsafe-member-access
      const blue = theme?.colors?.blue?.[600] as string ?? '#2563eb'
